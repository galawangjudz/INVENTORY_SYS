    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c_site', models.CharField(max_length=50, verbose_name='site')),
                ...
                ('c_status', models.CharField(max_length=50, verbose_name='status')),
                ('c_lot_type', models.CharField(max_length=50, verbose_name='lot_type')),
                ('c_title', models.CharField(max_length=50, verbose_name='title')),
